...
public:
	...
	void fprintCBT(ofstream& fout); // 파일출력함수
	void fprintCBT_byLevel(ofstream& fout); // 파일에 레벨별로 출력하는함수
protected:
	void _fprintCBT_byLevel(ofstream& fout, int p, int level); // 파일에 레벨별로 출력하는함수 (재귀)
